...
public class BoardDeleteST {
    ...
    @Test
    @DisplayName("WHEN deleting board with valid params THEN expect ok status")
    @Order(1)
    void whenDeletingBoardWithValidParams_thenExpectOkStatus() {
        testClient.delete()
